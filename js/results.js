new Vue({
  ...
  methods: {
    ...
    async search() {
      ...
      // if (cityData.indexOf(this.input.city) !== -1 && this.input.type === "") {
      //   windows.location.href = "http://192.168.2.102:5501/shopMap.html"
      // }
      if (cityData.indexOf(this.input.city) !== -1 && this.input.type.toLowerCase()) {
        location.href = "http://192.168.2.102:5501/shopMap.html"
